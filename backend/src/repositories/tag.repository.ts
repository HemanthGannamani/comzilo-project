...
export class TagRepository extends BaseRepository<Tag> {
  ...
  public async createScoped(tenantId: number, storeId: number, data: any): Promise<Tag> {
  ...
  public async restoreScoped(tenantId: number, storeId: number, id: number): Promise<Tag | null> {
