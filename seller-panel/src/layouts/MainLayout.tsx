  ...
  const navGroups: NavGroup[] = [
    ...
    },
    {
      ...
      items: [
        ...
        { label: 'Returns', path: '/orders', icon: <RotateCcw size={17} />, badge: 'RMA' },
    ...
    },
    {
      ...
      items: [
        ...
        { label: 'WhatsApp Marketing', path: '/marketing/whatsapp', icon: <MessageSquare size={17} /> },
    ...
    },
    {
      ...
      items: [
        { label: 'Payments', path: '/payments', icon: <CreditCard size={17} />, permission: 'payment.read' },
        { label: 'Refunds', path: '/payments', icon: <TrendingDown size={17} /> },
        { label: 'Taxes', path: '/settings', icon: <Receipt size={17} /> },
        { label: 'Expenses', path: '/reports', icon: <DollarSign size={17} /> },
        { label: 'Profit & Loss', path: '/reports', icon: <Percent size={17} /> },
      ],
    },
    {
      id: 'store',
      ...
      items: [
        ...
        { label: 'Reviews', path: '/dashboard', icon: <Star size={17} /> },
        { label: 'Support Tickets', path: '/dashboard', icon: <LifeBuoy size={17} /> },
        { label: 'Staff Management', path: '/settings', icon: <UserCheck size={17} /> },
        { label: 'Loyalty Program', path: '/marketing/coupons', icon: <Gift size={17} /> },
