...
export class BrandRepository extends BaseRepository<Brand> {
  ...
  public async createScoped(tenantId: number, storeId: number, data: any): Promise<Brand> {
  ...
  public async restoreScoped(tenantId: number, storeId: number, id: number): Promise<Brand | null> {
